...
desc "prepare addons for upload and upload them"
task :prepare_and_upload_addons_for_upload, [:bucket_url, :full_version] do |t, args|
...
task :fetch_and_upload_addons, [:bucket_url, :full_version] => [:prepare_and_upload_addons_for_upload]
